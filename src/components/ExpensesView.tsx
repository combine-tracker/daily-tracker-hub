...
export const ExpensesView: React.FC<ExpensesViewProps> = ({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-2xl p-3.5 sm:p-5 border border-rose-200/80 dark:border-rose-900/40 shadow-xs flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4">
        <div>
          <div className="flex items-center gap-2">
            <div className="p-2 sm:p-2.5 rounded-xl bg-rose-50 dark:bg-rose-950 text-rose-600 dark:text-rose-400 shrink-0">
              <TrendingDown className="w-4 h-4 sm:w-5 sm:h-5" />
            </div>
            <div>
              <h2 className="text-base sm:text-xl font-bold text-slate-900 dark:text-white">
                Daily Expense Log & Monthly Hierarchy
              </h2>
              <p className="text-[11px] sm:text-xs text-slate-500 dark:text-slate-400">
                Tracking Load, Food, Online, Family, and Others category expenses
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3 w-full sm:w-auto justify-between sm:justify-end border-t sm:border-t-0 pt-2 sm:pt-0 border-slate-100 dark:border-slate-800">
          <div className="text-left sm:text-right">
            <span className="text-[10px] sm:text-xs font-semibold text-slate-400 uppercase tracking-wider block">Total Expenses</span>
            <span className="text-lg sm:text-2xl font-black text-rose-600 dark:text-rose-400">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3.5 py-2 sm:px-4 sm:py-2.5 rounded-xl bg-rose-600 hover:bg-rose-700 text-white font-bold text-xs sm:text-sm shadow-md shadow-rose-500/20 transition-all active:scale-95 shrink-0"
          >
                    ...
                    {monthGroup.days.map((dayGroup) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="px-4 py-1.5 bg-rose-50/60 dark:bg-rose-950/30 border-t border-b border-rose-100 dark:border-rose-900/50 text-[11px] text-rose-900 dark:text-rose-300 font-medium flex items-center justify-between gap-2">
                            ...
                            <div className="flex items-center gap-2 shrink-0">
                              ...
                              <button
                                ...
                                className="px-2 py-0.5 rounded bg-rose-100 dark:bg-rose-950/80 hover:bg-rose-200 text-rose-800 dark:text-rose-300 font-bold text-[11px] transition-colors active:scale-95"
                              >
                                + Add to date
                              </button>
                            </div>
                          ...
                          {isDayOpen && (
                            <div className="p-3 space-y-2 bg-slate-50/50 dark:bg-slate-900/30">
                              {dayGroup.txs.map((tx) => (
                                ...
                                >
                                  <div className="flex items-center gap-3">
                                    <div className="px-2 py-1 rounded-md bg-rose-100 dark:bg-rose-950/80 text-rose-700 dark:text-rose-300 font-bold text-xs">
                                      {tx.category}
                                    </div>
                                    <div>
